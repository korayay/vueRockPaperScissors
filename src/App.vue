<template>
  <div class="bg-gray-700 text-white text-center min-h-screen flex flex-col">
    <header class="container mx-auto text-pink-500 p-6">Welcome to my game!</header>

    <main class="container mx-auto p-6 flex-1 mb-2 mt-2">
      <div
        v-if="choice === null"
        class="flex items-center justify-center -mx-6"
      >
        <div>
          <h1 class="text-4xl font-bold text-pink-500 mb-2">Rock</h1>
          <button
            @click="play('rock')"
            class="
              bg-white
        ...
        <div>
          <h1 class="text-4xl font-bold text-green-500 mb-2">Paper</h1>
          <button
            @click="play('paper')"
            class="
              bg-white
        ...
        <div>
          <h1 class="text-4xl font-bold text-yellow-500 mb-2">Scissors!</h1>
          <button
            @click="play('scissors')"
            class="
              bg-white
      ...
      <div v-else>
        <div class="text-3xl mb-4">
          You picked <span class="text-yellow-500">{{ choice }}</span>
        </div>
        <div class="text-3xl mb-4">
          The computer picked
      ...
      <button @click="ResetGame" class="bg-pink-500 text-lg py-2 px-4 mt-4">
        Reset Game
      </button>
    </main>
    ...
    <footer class="container mx-auto mb-4">
      <a
        href="https://github.com/korayay"
        target="_blank"
        class="text-yellow-500"
      >
        Rock Paper Scissors Game by Koray AY</a
      >
    </footer>
  </div>
</template>
